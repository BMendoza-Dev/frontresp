...
@Component({
  selector: 'app-table-nacionales',
  templateUrl: './table-nacionales.component.html',
  styleUrls: ['./table-nacionales.component.scss']
})
export class TableNacionalesComponent {
  editCorreoAdmin: any;
